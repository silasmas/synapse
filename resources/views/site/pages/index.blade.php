...
@section('content')
    ...
    <div class="rs-services style2 gray-bg pt-100 pb-100 md-pt-70 md-pb-70" id="rs-services">
        <div class="container">
            ...
            <div class="rs-carousel owl-carousel" data-loop="true"
                data-items="{{ $branches->count() >= 5 ? '3' : $branches->count() }}" data-margin="30" data-autoplay="true"
                data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="true" data-nav="false"
                data-nav-speed="false" data-md-device="{{ $branches->count() >= 5 ? '3' : $branches->count() }}"
                    ...
                    <div class="service-wrap">
                        <div class="image-part">
                            <img src="{{ asset('storage/' . $b->image) }}" alt="" height="260" width="360"
                                style="height: 260px !important;width: 360px !important">
                        </div>
                        <div class="content-part">
                            <h3 class="title"><a
                                    href="{{ route('detailBranches', ['id' => $b->id]) }}">{{ $b->titre }}</a></h3>
                            <div class="desc">
                                <p>
                            ...
                            <a href="{{ route('detailBranches', ['id' => $b->id]) }}" class="mt-3 d-block"
                                style="font-weight: 600">Savoir plus</a>
                        </div>
                    </div>
                @empty
                            ...
                            <div class="number-part">
                                ...
                                <div class="number-text">
                                    ...
                                    <div class="number-title">
                                        <h3 class="title"> Découverte</h3>
                                    </div>
                                    <div class="number-txt">
                                        Quisque placerat vitae focus scelerisque. Fusce luctus odio ac nibh luctus, in
                                        porttitor.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="rs-addon-number">
                            <div class="number-part">
                                ...
                                <div class="number-text">
                                    ...
                                    <div class="number-title">
                                        <h3 class="title">Planification</h3>
                                    </div>
                                    <div class="number-txt">
                                        Quisque placerat vitae focus scelerisque. Fusce luctus odio ac nibh luctus, in
                                        porttitor.
        ...
        <div class="container">
            ...
            <div class="rs-patter-section style1">
                <div class="container custom">
                    <div class="rs-carousel owl-carousel" data-loop="true"
                        data-items="{{ $partenaires->count() >= 5 ? '5' : $partenaires->count() }}" data-margin="30"
                        data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800"
                        data-dots="false" data-nav="false" data-nav-speed="false"
                            ...
                            <div class="logo-img">
                                <a href="#">
                                    <img style="height: 100px !important;width: 100px !important"
                                        class="hovers-logos rs-grid-img" src="{{ asset('storage/' . $p->logo) }}"
                                        title="" alt="{{ $p->titre }}">
                                    <img style="height: 100px !important;width: 100px !important"
                                        class="mains-logos rs-grid-img " src="{{ asset('storage/' . $p->logo) }}"
                                        title="" alt="{{ $p->titre }}">
                                </a>
                            </div>
                        @empty
    ...
    <div class="rs-testimonial style2 bg10 pt-100 pb-100 md-pt-70 md-pb-70"
        ...
        <div class="container">
            ...
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="{{ $temoignages->count() >= 3 ? '3' : '1' }}"
                ...
                data-ipad-device-dots2="true" data-md-device="{{ $temoignages->count() >= 3 ? '3' : '1' }}"
                data-md-device-nav="false" data-md-device-dots="true">
                @forelse ($temoignages as $t)
                    <div class="testi-wrap"
                        style="background-image: url('{{ asset('assets/images/testimonial/test-bg.jpg') }}') !important;">
            ...
            <div class="row y-middle">
                ...
                <div class="col-lg-6">
                    <div class="contact-wrap">
                        ...
                        <form id="contact-form" method="post" action="{{ route('sendmessage') }}"
                            data-parsley-validate>
                            @csrf
                            <fieldset>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 mb-30">
                                        <input class="from-control" type="text" id="name" name="nom"
                                            placeholder="Nom" required="" data-parsley-minlength="2"
